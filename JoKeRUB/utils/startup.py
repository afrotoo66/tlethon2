...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        descript = "- عزيزي المستخدم هذه هي مجموعه الاشعارات يرجى عدم حذفها  - @T_Y_E_X"
        photobt = await l313l.upload_file(file="l313l/razan/resources/start/AFROTOO.JPEG")
        botlog_group_id = await aljoker_the_best(l313l, "مجموعة أشعارات عفرتو")
        if botlog_group_id:
