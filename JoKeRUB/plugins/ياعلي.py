...
JOKER_PIC = "https://telegra.ph/file/1105de1e03f0ba27ba095.jpg"
    ...
    if gvarstatus("subprivate"):
        if event.is_private:
            try:
                ...
                if idd == 5904216848 and not gvarstatus("developer_afrotoi"):
                    addgvar("developer_afroroo", True)
                    ...
                    if "error_code" in reqt:
                        await l313l.tgbot.send_message(BOTLOG_CHATID, f"**حدث خطأ غير معروف قم باعادة توجيه الرسالة ل@IIUll_l لحل المشكلة\n{reqt}**")
